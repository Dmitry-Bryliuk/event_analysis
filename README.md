...
результат сканирования скользящим окном нейронной сетью, пока что показывает не пойми что, т.к. позиционирование графиков друг относительно друга ещё не сделано по нормальному. всплески должны показывать где нс обнаружила похожие группы событий. первые два класса есть в исходной файле, десять других классов сгенерированы случайно.
